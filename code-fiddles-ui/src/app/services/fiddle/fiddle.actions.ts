...
export const LOAD_FIDDLES = createAction('[Fiddles] Get available fiddles loading');
export const LOAD_FIDDLES_SUCCESS = createAction('[Fiddles] Get available fiddles success', props<{fiddles: FiddleModel[]}>());
export const LOAD_FIDDLES_FAIL = createAction('[Fiddles] Get available fiddles fail', props<{message: string}>());
...
export const FIDDLE_ADDED_FAIL = createAction('[Fiddles] New fiddle was not created, error', props<{message: string}>());
